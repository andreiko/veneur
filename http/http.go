...
// support it
func PostHelper(ctx context.Context, httpClient *http.Client, tc *trace.Client, endpoint string, bodyObject interface{}, action string, compress bool, log *logrus.Logger) error {
